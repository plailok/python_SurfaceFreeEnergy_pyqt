...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.theoryCombobox.setItemText(0, _translate("MainWindow", "Owens-Wendt"))
        self.theoryCombobox.setItemText(1, _translate("MainWindow", "Zisman"))
        self.theoryCombobox.setItemText(2, _translate("MainWindow", "van-Oss"))
        self.theoryCombobox.setItemText(3, _translate("MainWindow", "Fowkes"))
        self.tempCombobox.setItemText(0, _translate("MainWindow", f"18{degree}"))
        self.tempCombobox.setItemText(1, _translate("MainWindow", f"19{degree}"))
        self.tempCombobox.setItemText(2, _translate("MainWindow", f"20{degree}"))
        self.tempCombobox.setItemText(3, _translate("MainWindow", f"21{degree}"))
        self.tempCombobox.setItemText(4, _translate("MainWindow", f"22{degree}"))
        self.tempCombobox.setItemText(5, _translate("MainWindow", f"23{degree}"))
